...
standing and movement assets remain available. Town Center rendering draws
the present layer-5 footprint before its matching age/family body SLP. This
keeps terrain below the body's intentional openings without also drawing the
incomplete high-detail delta graph, which adds detached poles and fragments.
Missing layers do not authorize a future-Age or procedural overlay.
