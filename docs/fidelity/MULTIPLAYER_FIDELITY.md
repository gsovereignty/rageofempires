...
| Supplied HD seam | Strict synthetic-golden codecs for recovered Steam P2P outer records `0x1f5`, `0x1f8`, and fixed-size `0x259`; exact observed lobby metadata keys | Steam lobby/identity/P2P/auth runtime, inner commercial packet schemas, and original-client interoperability proof |
